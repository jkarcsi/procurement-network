...
type SupplierSeed = {
  ...
  description: string;
  phone: string;
  // korábbi aktivitás a rangsoroláshoz
  inviteCount: number;
...
const SUPPLIERS: SupplierSeed[] = [
  // Takarítás
  { name: "CleanPro Facility Kft.", email: "ajanlat@cleanpro.hu", categories: ["takaritas"], regions: ["budapest", "pest"], certifications: "ISO 9001", description: "Irodaházak és üzemek napi takarítása 120 fős csapattal.", phone: "+36 1 234 5670", inviteCount: 24, responseCount: 19, avgResponseHours: 9 },
  { name: "Tisztaság Mester Bt.", email: "info@tisztasagmester.hu", categories: ["takaritas"], regions: ["budapest"], description: "Kis- és középirodák rugalmas takarítása, zöld tisztítószerekkel.", phone: "+36 30 111 2233", inviteCount: 11, responseCount: 7, avgResponseHours: 16 },
  { name: "Brillant Clean Zrt.", email: "sales@brillantclean.hu", categories: ["takaritas"], regions: ["budapest", "pest", "fejer"], nationwide: true, certifications: "ISO 9001, ISO 14001", description: "Országos lefedettségű facility cég, multinacionális referenciákkal.", phone: "+36 1 700 8800", inviteCount: 35, responseCount: 24, avgResponseHours: 12 },
  { name: "Alföld Higiénia Kft.", email: "iroda@alfoldhigienia.hu", categories: ["takaritas"], regions: ["csongrad-csanad", "bacs-kiskun", "bekes"], description: "Dél-alföldi ipari és irodai takarítás, élelmiszeripari tapasztalattal.", phone: "+36 62 400 100", inviteCount: 8, responseCount: 6, avgResponseHours: 20 },
  { name: "Nyugat Clean Kft.", email: "ajanlat@nyugatclean.hu", categories: ["takaritas"], regions: ["gyor-moson-sopron", "vas", "veszprem"], description: "Győri központú takarítócég, autóipari beszállítói referenciákkal.", phone: "+36 96 320 450", inviteCount: 14, responseCount: 10, avgResponseHours: 14 },
  // HVAC
  ...
  // Őrzés-védelem
  { name: "Guard Force Security Zrt.", email: "uzlet@guardforce.hu", categories: ["orzes-vedelem"], regions: ["budapest", "pest"], nationwide: true, certifications: "Rendőrségi működési engedély", description: "Élőerős őrzés, távfelügyelet és beléptetőrendszerek 800 fős állománnyal.", phone: "+36 1 666 7700", inviteCount: 26, responseCount: 18, avgResponseHours: 10 },
  { name: "Bástya Vagyonvédelem Kft.", email: "info@bastyavedelem.hu", categories: ["orzes-vedelem"], regions: ["budapest"], certifications: "Rendőrségi működési engedély", description: "Irodaházi portaszolgálat és recepciós szolgáltatás fővárosi fókusszal.", phone: "+36 30 777 8899", inviteCount: 13, responseCount: 9, avgResponseHours: 18 },
  { name: "Patrol-24 Kft.", email: "ajanlat@patrol24.hu", categories: ["orzes-vedelem"], regions: ["borsod-abauj-zemplen", "heves", "hajdu-bihar"], certifications: "Rendőrségi működési engedély", description: "Észak-magyarországi járőrszolgálat és telephelyőrzés.", phone: "+36 46 505 050", inviteCount: 7, responseCount: 5, avgResponseHours: 15 },
  { name: "Szeged Security Bt.", email: "iroda@szegedsecurity.hu", categories: ["orzes-vedelem"], regions: ["csongrad-csanad", "bekes"], description: "Dél-alföldi vagyonvédelem, logisztikai központok őrzése.", phone: "+36 62 420 420", inviteCount: 5, responseCount: 3, avgResponseHours: 28 },
  // Munkavédelem
  { name: "MunkaSzab Consulting Kft.", email: "iroda@munkaszab.hu", categories: ["munkavedelem", "tuzvedelem"], regions: ["budapest", "pest"], nationwide: true, certifications: "Munkavédelmi szakmérnök, tűzvédelmi szakvizsga", description: "Munka- és tűzvédelmi átalánydíjas szolgáltatás KKV-knak, 400+ ügyfél.", phone: "+36 1 333 4455", inviteCount: 22, responseCount: 18, avgResponseHours: 8 },
  { name: "SafeWork Hungary Bt.", email: "info@safework.hu", categories: ["munkavedelem"], regions: ["budapest"], certifications: "Munkavédelmi technikus", description: "Kockázatértékelés, oktatások és bejárások rugalmas időpontokban.", phone: "+36 70 222 3344", inviteCount: 10, responseCount: 8, avgResponseHours: 12 },
  { name: "Védőháló Munkavédelem Kft.", email: "ajanlat@vedohalo.hu", categories: ["munkavedelem"], regions: ["gyor-moson-sopron", "komarom-esztergom", "vas"], certifications: "Munkavédelmi szakmérnök", description: "Ipari munkavédelem a Nyugat-Dunántúlon, gyártósori tapasztalattal.", phone: "+36 96 550 660", inviteCount: 9, responseCount: 7, avgResponseHours: 10 },
  { name: "Alföldi Munkabiztonság Kft.", email: "info@alfoldimunkabiztonsag.hu", categories: ["munkavedelem", "tuzvedelem"], regions: ["hajdu-bihar", "jasz-nagykun-szolnok", "bekes"], certifications: "Munkavédelmi technikus, tűzvédelmi előadó", description: "Munka- és tűzvédelem egy kézből kelet-magyarországi telephelyekre.", phone: "+36 52 410 410", inviteCount: 6, responseCount: 4, avgResponseHours: 19 },
  // Tűzvédelem
  { name: "FireStop Mérnökiroda Kft.", email: "iroda@firestop.hu", categories: ["tuzvedelem"], regions: ["budapest", "pest"], nationwide: true, certifications: "Tűzvédelmi szakértő, OKF regisztráció", description: "Tűzvédelmi szabályzatok, tűzjelző karbantartás, hatósági képviselet.", phone: "+36 1 444 5566", inviteCount: 18, responseCount: 14, avgResponseHours: 9 },
  { name: "Lángőr Bt.", email: "info@langor.hu", categories: ["tuzvedelem"], regions: ["budapest"], certifications: "Tűzvédelmi előadó", description: "Tűzoltó készülék felülvizsgálat és tűzvédelmi oktatás kisvállalatoknak.", phone: "+36 20 888 9900", inviteCount: 8, responseCount: 5, avgResponseHours: 21 },
  { name: "Pécs Tűzvédelem Kft.", email: "ajanlat@pecstuzvedelem.hu", categories: ["tuzvedelem", "munkavedelem"], regions: ["baranya", "somogy", "tolna"], certifications: "Tűzvédelmi szakvizsga", description: "Dél-dunántúli tűz- és munkavédelmi szolgáltató, ipari parki referenciák.", phone: "+36 72 310 310", inviteCount: 5, responseCount: 4, avgResponseHours: 16 },
  // IT support
...
async function main() {
  ...
  // Demo beszállítói fiók (a CleanPro-hoz kötve)
  ...
  console.log("Demo vevő:      demo@vevo.hu / demo1234");
  console.log("Demo beszállító: demo@beszallito.hu / demo1234");
}
